...
class FieldPaletteModel extends \Model
{
     ...
     * @return \Model\Collection|\ContentModel|null A collection of models or null if there are no fieldpalette elements
     */
    public static function findPublishedByPidsAndTableAndField($arrPids, $strParentTable, $strParentField, array $arrOptions = [])
    {
        ...
        return static::findBy($arrColumns, [$strParentTable, $strParentField], $arrOptions);
    }
